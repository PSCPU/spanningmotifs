...
- `.hb2` files
- Corresponding `_modified.pdb` files

Note: The codes depend on the PDB file name. We use this naming convention to ensure that the scripts are run only on the cleaned PDB files generated by Phenix, which adds _modified to the original PDB file name.
